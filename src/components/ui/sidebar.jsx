    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-sidebar z-200 text-sidebar-foreground w-(--sidebar-width) p-0 [&>button]:hidden"
          style={
            {
  ...
  return (
    <div
      ...
      <div
        ...
        className={cn(
          "relative w-[16rem] lg:w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear",
